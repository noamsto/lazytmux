{
  ...
  tmuxConfText = pkgs.writeText "tmux.conf" ''
    ...
    bind a run-shell '${script.tmux-window-picker}/bin/tmux-window-picker --client "#{client_name}" --claude'
    ...
    # The three tickers below exist only for their side effects and print
